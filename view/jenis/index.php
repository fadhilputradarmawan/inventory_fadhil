...
<table class="table table-bordered">
        <tr>
            ...
            <th class="table-dark">Nama Jenis</th>
        ...
        if(mysqli_num_rows($query)>0){
            while($result=mysqli_fetch_assoc($query)){
                ...
                <tr>
                    ...
                    <td>
                      <a href="edit.php?Id_Jenis=<?php echo $result['Id_Jenis'];?>" class="btn btn-outline-warning"><i class="fa-solid fa-pen-to-square"></i>EDIT</a>
                    </td>
                </tr>
                <?php
            }
